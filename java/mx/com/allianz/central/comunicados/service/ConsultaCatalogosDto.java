...
/**
 * <p>
 * Clase Java para ConsultaCatalogosDto complex type.
 * 
 * <p>
 ...
 * 
 * <pre>
 * &lt;complexType name="ConsultaCatalogosDto"&gt;
 *   &lt;complexContent&gt;
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *       &lt;sequence&gt;
 *         &lt;element name="catalogos" type="{http://dto.centralcomunicados.allianz.com.mx}CatalogoDto" maxOccurs="unbounded"/&gt;
...
@XmlType(name = "ConsultaCatalogosDto", propOrder = { "catalogos", "codigoError", "resultado" })
public class ConsultaCatalogosDto {

	@XmlElement(required = true, nillable = true)
	protected List<CatalogoDto> catalogos;
	@XmlElement(required = true, nillable = true)
	...
	/**
	 * Gets the value of the catalogos property.
	 * 
	 * <p>
	 * This accessor method returns a reference to the live list, not a snapshot.
	 * Therefore any modification you make to the returned list will be present
	 * inside the JAXB object. This is why there is not a <CODE>set</CODE> method
	 * for the catalogos property.
	 * 
	 * <p>
	 * For example, to add a new item, do as follows:
	 * 
	 * <pre>
	 * getCatalogos().add(newItem);
	 * </pre>
	 * 
	 * 
	 * <p>
	...
	public List<CatalogoDto> getCatalogos() {
		if (catalogos == null) {
			catalogos = new ArrayList<CatalogoDto>();
		}
