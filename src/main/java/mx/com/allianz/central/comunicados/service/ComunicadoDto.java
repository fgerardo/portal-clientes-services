...
public class ComunicadoDto extends AudienciaDto {
	...
	@XmlElement(namespace = "http://dto.centralcomunicados.allianz.gob.mx", required = true, type = Long.class, nillable = true)
	protected Long idComunicado;
	@XmlElement(namespace = "http://dto.centralcomunicados.allianz.gob.mx", required = true, nillable = true)
