...
@XmlType(name = "", propOrder = { "correoElectronico" })
@XmlRootElement(name = "ObtenerListaComunicadosByUsuarioAndCanalRequest", namespace = "http://serviceparameters.dto.centralcomunicados.allianz.com.mx")
public class ObtenerListaComunicadosByUsuarioAndCanalRequest {
