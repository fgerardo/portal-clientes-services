...
/**
 * <p>Clase Java para decryptWithUrlUnEscapeResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="decryptWithUrlUnEscapeResponse"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "decryptWithUrlUnEscapeResponse", propOrder = {
    "outOpciones"
})
@XmlRootElement(name = "decryptWithUrlUnEscapeResponse")
public class DecryptWithUrlUnEscapeResponse {
