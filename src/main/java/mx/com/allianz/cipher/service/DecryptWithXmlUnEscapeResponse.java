...
/**
 * <p>Clase Java para decryptWithXmlUnEscapeResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="decryptWithXmlUnEscapeResponse"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "decryptWithXmlUnEscapeResponse", propOrder = {
    "outOpciones"
})
public class DecryptWithXmlUnEscapeResponse {
