...
/**
 * <p>Clase Java para cryptWithXmlEscapeResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="cryptWithXmlEscapeResponse"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "cryptWithXmlEscapeResponse", propOrder = {
    "outOpciones"
})
public class CryptWithXmlEscapeResponse {
