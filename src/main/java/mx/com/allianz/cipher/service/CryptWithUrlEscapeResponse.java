...
/**
 * <p>Clase Java para cryptWithUrlEscapeResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="cryptWithUrlEscapeResponse"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "cryptWithUrlEscapeResponse", propOrder = {
    "outOpciones"
})
@XmlRootElement(name = "cryptWithUrlEscapeResponse")
public class CryptWithUrlEscapeResponse {
