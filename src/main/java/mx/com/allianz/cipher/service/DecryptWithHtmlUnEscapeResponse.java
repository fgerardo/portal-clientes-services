...
/**
 * <p>Clase Java para decryptWithHtmlUnEscapeResponse complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="decryptWithHtmlUnEscapeResponse"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "decryptWithHtmlUnEscapeResponse", propOrder = {
    "outOpciones"
})
public class DecryptWithHtmlUnEscapeResponse {
