 ...
 * @Clase: ZeroException.java <br/>
 *         Excepcion de utilerías
 * @version 1.0.0
 */
public class ZeroException extends RuntimeException {
	 ...
	 * Logger de clase
	 */
	private static final Logger LOGGER = LoggerFactory.getLogger(ZeroException.class);
	 ...
	 */
	public ZeroException(final String message, final String... params) {
	 ...
	 *            parametros del mensaje
	 */
	public ZeroException(Exception e, final String message, final String... params) {
		super(Codes.formatMsg(message, (Object[]) params), e);
		LOGGER.error("Error registrado en utilerias Isban-Commons - Detalle: {}", Codes.formatMsg(message, (Object[]) params));
		this.params = Arrays.copyOf(params, params.length);
	}
